...
class ButtonComponent < ViewComponent::Base
  STYLES = {
    ...
    warning: "bg-amber-500 hover:bg-amber-400 text-white shadow-lg hover:shadow-amber-500/25",
    default: "bg-slate-600 hover:bg-slate-500 text-white shadow-lg hover:shadow-slate-500/25",
