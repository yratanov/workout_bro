  ...
  class ImportsController < ApplicationController
    ...
    def destroy
      ...
      redirect_to settings_imports_path,
                  notice:
                    I18n.t(
                      "controllers.settings.imports.reverted",
                      count: deleted_count
                    )
    end
