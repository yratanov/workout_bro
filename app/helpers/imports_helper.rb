  ...
  def status_badge_config(status)
    configs = {
      "pending" => {
        ...
        classes: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-900/50 text-yellow-300"
      },
      "in_progress" => {
      ...
      "completed" => {
        ...
        classes: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-900/50 text-green-300"
      },
      "failed" => {
        text: I18n.t("settings.imports.show.statuses.failed"),
        classes: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-900/50 text-red-300"
      }
    }
