...
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name workout_bro workout_bro
...
# This also builds Tailwind CSS via the tailwindcss-rails gem hook
