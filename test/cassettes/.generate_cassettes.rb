...
# === GeminiClient ===
write_cassette("gemini_client/generate_success", [interaction(url: url25, status: 200, res_body: success_body("Generated response"))])
write_cassette("gemini_client/generate_401", [interaction(url: url25, status: 401, res_body: "Unauthorized")])
write_cassette("gemini_client/generate_403", [interaction(url: url25, status: 403, res_body: "Forbidden")])
write_cassette("gemini_client/generate_429", [
...
write_cassette("gemini_client/stream_success", [interaction(url: stream25, status: 200, res_body: sse_body("Hello world!", input_tokens: 5, output_tokens: 3, total_tokens: 8), content_type: "text/event-stream")])
write_cassette("gemini_client/stream_response", [interaction(url: stream25, status: 200, res_body: sse_body("Response", input_tokens: 5, output_tokens: 3, total_tokens: 8), content_type: "text/event-stream")])
write_cassette("gemini_client/stream_logged", [interaction(url: stream25, status: 200, res_body: sse_body("Streamed", input_tokens: 10, output_tokens: 5, total_tokens: 15), content_type: "text/event-stream")])
...
write_cassette("ai_workout_feedback/simple", [interaction(url: url20, status: 200, res_body: success_body("Basic feedback"))])
write_cassette("ai_workout_feedback/run", [interaction(url: url20, status: 200, res_body: success_body("Nice run!"))])
write_cassette("ai_weekly_report/chat", [interaction(url: url20, status: 200, res_body: success_body("Weekly report"))])
write_cassette("ai_weekly_report/simple", [interaction(url: url20, status: 200, res_body: success_body("Basic report"))])
write_cassette("ai_weekly_report/with_data", [interaction(url: url20, status: 200, res_body: success_body("Report"))])
write_cassette("ai_weekly_report/no_workouts", [interaction(url: url20, status: 200, res_body: success_body("Report"))])
write_cassette("ai_weekly_report/with_prs", [interaction(url: url20, status: 200, res_body: success_body("Report"))])
write_cassette("ai_weekly_report/run_format", [interaction(url: url20, status: 200, res_body: success_body("Report"))])
write_cassette("ai_weekly_report/russian", [interaction(url: url20, status: 200, res_body: success_body("Report"))])
write_cassette("ai_weekly_report/english", [interaction(url: url20, status: 200, res_body: success_body("Report"))])
write_cassette("ai_history_review/generate", [interaction(url: url20, status: 200, res_body: success_body("Training review content"))])
write_cassette("ai_history_review/with_data", [interaction(url: url20, status: 200, res_body: success_body("Review"))])
write_cassette("ai_compaction/chat", [interaction(url: url20, status: 200, res_body: success_body("Compacted review"))])

# === Job tests ===
write_cassette("jobs/workout_feedback/streaming", [interaction(url: stream20, status: 200, res_body: sse_body("Great workout!"), content_type: "text/event-stream")])
write_cassette("jobs/workout_feedback/simple", [interaction(url: url20, status: 200, res_body: success_body("Simple feedback"))])
write_cassette("jobs/workout_feedback/error", [interaction(url: stream20, status: 500, res_body: "API connection failed")])
